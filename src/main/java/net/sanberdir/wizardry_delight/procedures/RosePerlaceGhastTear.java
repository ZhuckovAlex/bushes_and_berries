...
public class RosePerlaceGhastTear {
    ...
    private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
        if (entity == null)
            return;
        if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == InitBlocks.ROSE_OF_GHOSTY_TEARS.get() && (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.SPONGE) {
            ...
            world.levelEvent(2001, new BlockPos(x, y, z), Block.getId(InitBlocks.ROSE_OF_GHOSTY_TEARS.get().defaultBlockState()));
        }
    }
