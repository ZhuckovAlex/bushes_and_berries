...
public class ModBoatItem extends Item {
    ...
    private final CustomBoat.TypeMod typeMod;
    private final boolean hasChest;

    public ModBoatItem(boolean p_220013_, CustomBoat.TypeMod p_220014_, Properties p_220015_) {
        super(p_220015_);
        this.hasChest = p_220013_;
        this.typeMod = p_220014_;
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_40622_, Player p_40623_, InteractionHand p_40624_) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                CustomBoat boat = this.getBoat(p_40622_, hitresult);
                boat.setType(this.typeMod);
    ...
    private CustomBoat getBoat(Level p_220017_, HitResult p_220018_) {
        return (CustomBoat)(this.hasChest ? new ChestBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) : new CustomBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z));
    }
}
