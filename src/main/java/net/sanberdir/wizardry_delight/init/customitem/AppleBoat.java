...
import net.sanberdir.wizardry_delight.entity.boat.ModBoatEntity;
import net.sanberdir.wizardry_delight.entity.boat.ModBoatTypes;
...
public class AppleBoat extends Item {
    ...
    public AppleBoat() {
        super(new Item.Properties().stacksTo(1).tab(ModCreativeModeTab.BUSHES));
