...
public class ModPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> CHARNIKA_PLACED = PLACED_FEATURES.register("charnika_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.CHARNIKA.getHolder().get(), List.of(RarityFilter.onAverageOnceEvery(5),
                    InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));

    public static final RegistryObject<PlacedFeature> YADOGA_PLACED = PLACED_FEATURES.register("yadoga_placed",
    ...
    public static final RegistryObject<PlacedFeature> APPLE_CHECKED = PLACED_FEATURES.register("apple_checked",
            () -> new PlacedFeature(ModConfiguredFeatures.APPLE_TREE.getHolder().get(),
                    List.of(PlacementUtils.filteredByBlockSurvival(InitBlocks.APPLE_SAPLING.get()))));
