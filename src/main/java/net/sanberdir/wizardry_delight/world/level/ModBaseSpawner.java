package net.sanberdir.wizardry_delight.world.level;
...
public abstract class ModBaseSpawner extends BaseSpawner {
    ...
    public void setEntityId(EntityType<?> entityType) {
        this.nextSpawnData.getEntityToSpawn().putString("getEntity1", Registry.ENTITY_TYPE.getKey(entityType).toString());
    }
                ...
                for(int i = 0; i < this.spawnCount; ++i) {
                    ...
                    if (p_151312_.noCollision(optional.get().getAABB(d0, d1, d2))) {
                        ...
                        if (entity instanceof Mob) {
                            ...
                            if (this.nextSpawnData.getEntityToSpawn().size() == 1 && this.nextSpawnData.getEntityToSpawn().contains("getEntity1", 8)) {
    ...
    public Entity getOrCreateDisplayEntity(Level p_151315_) {
        if (this.displayEntity == null) {
            ...
            if (this.nextSpawnData.getEntityToSpawn().size() == 1 && this.nextSpawnData.getEntityToSpawn().contains("getEntity1", 8) && this.displayEntity instanceof Mob) {
            }
        }
